	...
	return (
		<main className=' w-full mx-auto transition-all duration-300'>
			...
			<div className='flex flex-col max-w-[900px] ml-[210px]'>
				<div className='flex'>
					<Image className='max-w-[60px] h-[60px] rounded-full' src={author.image} alt='Author' width={60} height={60} sizes='60x60' priority={false} />
					<div className='flex flex-col justify-center ml-5 text-[#696969] dark:text-[#9c9c9c]'>
						<p className='font-Oswald font-semibold text-md text-[#1c1c1c] dark:text-[#f0f0f0]'>{author.name}</p>
						<p className='font-Quicksand font-normal text-sm'>{author.job}</p>
					</div>
				</div>
