				...
				<div className=' ml-[30px] flex flex-col justify-between'>
					<ul>
						<li className='flex flex-col'>
							<div className='flex items-center gap-4 font-Quicksand font-medium text-xs text-[#696969] dark:text-[#f0f0f0]'>
								<p className='flex justify-center items-center bg-[#696969] dark:bg-[#f0f0f0] font-Quicksand font-normal text-xs w-[90px] h-5 bg-[#d6d6d6] text-[#1c1c1c] rounded-full'>{category}</p>
								<div className='w-[0.5px] h-[20px] rounded-full bg-[#696969] dark:bg-[#f0f0f0]'></div>
					...
					<div>
						...
						<div className='flex'>
							<div className='flex items-center gap-5'>
								...
								<div className='text-[#696969] dark:text-[#9c9c9c]'>
