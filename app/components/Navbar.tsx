		...
		<nav className='w-[1320px] h-20 mx-auto mt-[30px] bg-[#f0f0f0] dark:bg-[#1c1c1c] border border-[#696969] rounded-full transition-all duration-300'>
			<div className=' h-full flex items-center'>
				...
				<div className=' ml-[580px] flex gap-x-11 font-Quicksand'>
					...
					<Link href='https://buymeacoffee.com/vkar' className='text-[#1c1c1c] dark:text-[#f0f0f0] no-underline text-xl font-normal opacity-90 hover:opacity-100 transition-opacity duration-300'>Support Me</Link>
					<ThemeSwitcher />
				</div>
			</div>
		</nav>
